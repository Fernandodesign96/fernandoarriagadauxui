            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div className="flex flex-col justify-center gap-8 h-full">
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                        ...
                        <a href="https://github.com/Fernandodesign96" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors w-fit">
